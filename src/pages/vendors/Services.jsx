        ...
        <AnimatePresence>
          {services.length === 0 && (
            ...
            >
              ...
              <button className='bg-purple-600 text-white px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest shadow-xl shadow-purple-200 hover:bg-gray-900 transition-all flex items-center gap-3 mx-auto'>
                <Plus size={20} />
