...
const VendorServices = () => {
  ...
  // Fetch vendor services from Firestore
  useEffect(() => {
    if (!currentUser) {
      setLoading(false);
      return;
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.imageFile) {
        ...
        // Use URL directly if it's a web link
  ...
  if (!currentUser) {
    return (
      <div className='min-h-screen bg-[#fafafa] font-sans text-gray-900 flex items-center justify-center p-4'>
      ...
      <main className='max-w-7xl mx-auto p-6 lg:p-10'>
        ...
        <header className='flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12'>
          ...
          <motion.button
            ...
            className='bg-gray-900 hover:bg-purple-600 text-white px-8 py-4 rounded-3xl flex items-center justify-center gap-3 transition-all font-black text-sm shadow-xl shadow-gray-200 hover:shadow-purple-200'
          >
                    ...
                    <div className='p-8'>
                      ...
                      {service.features && service.features.length > 0 && (
                        <div className='flex flex-wrap gap-2 mb-4'>
                          {service.features.slice(0, 3).map((feature, idx) => (
                            <span
                              key={idx}
                              className='text-[11px] font-black uppercase tracking-widest bg-purple-50 text-purple-700 px-3 py-2 rounded-full'
                            >
                              {feature}
                            </span>
                          ))}
                      ...
                      <div className='flex gap-3'>
                        <button
                          ...
                          className='flex-3 bg-gray-50 hover:bg-purple-600 hover:text-white text-gray-900 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2'
                        >
                          <Edit3 size={16} />
                          Edit Service
                        </button>
              ...
              {services.length === 0 && (
                ...
                >
                  ...
                  <p className='text-gray-500 font-medium mb-10 max-w-sm mx-auto leading-relaxed'>
                    Start adding your professional event services to get
                    discovered by thousands of clients like Justice Adam.
                  </p>
              ...
              >
                ...
                <div className='space-y-2'>
                  ...
                  <input
                    type='text'
                    name='features'
                    placeholder='e.g., Full setup, menu tasting, 24/7 support'
                ...
                <div className='flex gap-4 pt-4 border-t border-gray-50 shrink-0'>
                  ...
                  >
                    {editingService ? "Update Package" : "Deploy Package"}
                  </button>
                </div>
              </form>
            </motion.div>
