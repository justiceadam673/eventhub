    ...
    <section className='relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden bg-[#fafafa]'>
      ...
      >
        ...
        <motion.div
          ...
          className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-50 border border-purple-100 text-purple-600 text-sm font-semibold mb-6 shadow-sm'
        >
        ...
        >
          <button className='group flex items-center gap-2 text-gray-600 font-bold hover:text-purple-600 transition-colors'>
            Explore All Vendors
            <ArrowRight
              size={18}
          ...
          <button className='text-gray-500 font-medium hover:underline decoration-purple-300 underline-offset-4'>
